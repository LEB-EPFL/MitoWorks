function [mesh, Contour, subNormals, DiametersSnake,MidPoint, meshGT, subNormalsGT, DiametersSnakeGT]=mitoMesh(fname,ContnextX,ContnextY,PixelSize, Offset,startFrame,endFrame, pos,meshD, GTcontour)
